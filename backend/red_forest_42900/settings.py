"""
Django settings for red_forest_42900 project.
...
ROOT_URLCONF = 'red_forest_42900.urls'
...
WSGI_APPLICATION = 'red_forest_42900.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_forest_42900 API",
    "DESCRIPTION": "API documentation for red_forest_42900 App",
    "VERSION": "v1",
}
